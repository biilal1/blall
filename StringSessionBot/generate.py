...
async def generate_session(bot, msg, telethon=False):
    ...
    phone_number_msg = await bot.ask(
        user_id,
        "الآن أرسل رقم الهاتف الخاص بكᴘʜᴏɴᴇ_ɴᴜᴍʙᴇʀ قم بكتابة رقم مع رمز بلدك. \nمثال : `+9647727964881`",
